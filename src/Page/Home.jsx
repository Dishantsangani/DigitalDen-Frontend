...
import backg from "../assets/Background/Background.jpg";
import shopinglist from "../assets/Customer/shopping-list.svg";
import { ToastContainer, toast } from "react-toastify";

function Home({ onAddSuccess }) {
              ...
              <div className="w-full xl:col-span-7  lg:col-span-6 block">
                <div className="w-full  sm:w-auto lg:w-[60.8125rem] xl:ml-16">
                  <img
                    src={backg}
                    alt="Dashboard image"
                    className="rounded-l-3xl object-cover w-2xl"
                  />
                </div>
              </div>
            </div>
      ...
      <section className="bg-white py-8 antialiased  md:py-16">
        <div className="mx-auto grid max-w-screen-xl px-4 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-16 xl:gap-0">
          <div className="content-center justify-self-start md:col-span-7 md:text-start ">
            <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:max-w-2xl md:text-5xl xl:text-6xl">
              Limited Time Offer!
              <br />
              Up to 50% OFF!
            </h1>
      ...
      {loading ? (
        <div class="flex-col gap-4 w-full flex items-center justify-center">
          <div class="w-20 h-20 border-4 border-transparent text-blue-400 text-4xl animate-spin flex items-center justify-center border-t-blue-400 rounded-full">
            <div class="w-16 h-16 border-4 border-transparent text-indigo-400 text-2xl animate-spin flex items-center justify-center border-t-indigo-400 rounded-full"></div>
          </div>
        </div>
      ) : (
        ""
